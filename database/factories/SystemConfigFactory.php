...
class SystemConfigFactory extends Factory
{
    ...
    public function definition(): array
    {
        $configs = [
            ...
            ['key' => 'platform_payout_enabled', 'value' => 'true', 'description' => 'Enable scheduled platform profit payouts'],
            ['key' => 'platform_payout_auto_process', 'value' => 'true', 'description' => 'Automatically process platform profit payout batches'],
            ['key' => 'platform_payout_settlement_days', 'value' => '7', 'description' => 'Days before completed order items become payoutable'],
            ['key' => 'order_auto_complete_days', 'value' => '7', 'description' => 'Days before delivered order items are auto-completed'],
