<div>
    @section('pageTitle', __('admin.titles.manage_escrows'))
    ...
    <div class="bg-white dark:bg-slate-800 shadow rounded-md w-full relative">
        <div class="border-b border-dashed border-slate-200 dark:border-slate-700 py-3 px-4 dark:text-slate-300/70">
            <h4 class="font-medium">{{ __('admin.titles.manage_escrows') }}</h4>
        </div>
    ...
    <!-- View Modal -->
    <x-reusable.modal wire:model="showViewModal" :title="__('admin.modal.escrow_details')" max-width="3xl">
        @if($viewData)
            <div class="space-y-4">
                <!-- Escrow Header Info -->
