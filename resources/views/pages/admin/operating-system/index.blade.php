<div>
    @section('pageTitle', __('admin.titles.manage_operating_systems'))
    ...
    @push('breadcrumbs')
        <x-partials.dashboard.breadcrumb :items="[
            ...
            ['label' => __('admin.nav.operating_systems'), 'url' => 'javascript:void(0)'],
        ]" />
    @endpush
    ...
    <x-reusable.modal wire:model="showCreateModal" :title="__('admin.modal.create_operating_system')" max-width="2xl">
        <form id="createOperatingSystemForm" wire:submit="createOperatingSystem">
            <div class="space-y-6">
                    ...
                    <div class="space-y-4 pt-4">
                        <div>
                            ...
                            <input wire:model="createForm.name" type="text" id="name"
                                   ...
                                   placeholder="{{ __('admin.placeholders.operating_system_name') }}" required aria-required="true">
                ...
                <div>
                    <h3 class="text-sm font-medium text-slate-900 dark:text-slate-100 pb-2 border-b border-slate-200 dark:border-slate-700">{{ __('admin.common.visual') }}</h3>
                    <div class="space-y-4 pt-4">
                        <div>
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
                <button wire:target="createOperatingSystem" type="submit"
                    ...
                    <span wire:loading wire:target="createOperatingSystem">{{ __('admin.common.saving') }}</span>
                    <span wire:loading.remove wire:target="createOperatingSystem">{{ __('admin.common.submit') }}</span>
                </button>
    ...
    <x-reusable.modal wire:model="showViewModal" :title="__('admin.modal.operating_system_details')" max-width="2xl">
        @if($viewData)
            <div class="space-y-4">
    ...
    <x-reusable.modal wire:model="showEditModal" :title="__('admin.modal.edit_operating_system', ['id' => $editForm->operatingSystem?->id])" max-width="2xl">
        <form id="editOperatingSystemForm" wire:submit="updateOperatingSystem">
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
                <button wire:target="updateOperatingSystem" type="submit"
                        class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50">
                    <span wire:loading wire:target="updateOperatingSystem">{{ __('admin.common.saving') }}</span>
                    <span wire:loading.remove wire:target="updateOperatingSystem">{{ __('admin.common.update') }}</span>
                </button>
    ...
    <x-reusable.modal wire:model="showBulkStatusModal" :title="__('admin.modal.change_operating_system_status')" max-width="md">
