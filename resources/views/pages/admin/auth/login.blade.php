<div>
    ...
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ __('admin.auth.login_title') }}</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('admin.auth.login_subtitle') }}</p>
    </div>
    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ __('admin.auth.remember_me') }}</label>
            </div>
        </div>
