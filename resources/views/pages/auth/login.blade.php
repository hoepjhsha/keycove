    ...
    <div class="flex flex-col lg:flex-row min-h-screen w-full bg-[#FCF9F4] dark:bg-gray-950">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-[#F6EBD9] dark:bg-gray-900 relative flex-col pt-32 px-16 lg:px-24 overflow-hidden border-r border-gray-200 dark:border-gray-800">
            ...
            <div class="relative z-20">
                <h1 class="text-[42px] font-bold text-black dark:text-white mb-2 tracking-tight">Đăng nhập</h1>
                <div class="flex items-center text-[15px] font-medium text-black/70 dark:text-gray-400 space-x-3">
                    ...
                    <span class="text-black dark:text-white">Đăng nhập</span>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 pt-28 sm:p-12 sm:pt-32">
            <div class="w-full max-w-[500px] bg-white dark:bg-gray-900 border border-gray-400 dark:border-gray-700 rounded-[2rem] p-8 sm:p-12">
                ...
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold text-black dark:text-white mb-2">Đăng nhập</h2>
                    <p class="text-[15px] text-gray-600 dark:text-gray-400">Chào mừng bạn quay lại, vui lòng đăng nhập vào tài khoản.</p>
                </div>
                ...
                <form wire:submit="login" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2.5 text-[14px] text-gray-700 dark:text-gray-300 cursor-pointer">Ghi nhớ đăng nhập</label>
                        </div>
                        <a href="{{ route('app.auth.password.request') }}" class="text-[14px] text-[#D32F2F] hover:underline">Quên mật khẩu?</a>
                    </div>
