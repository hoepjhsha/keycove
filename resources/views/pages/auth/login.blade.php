<div>
    ...
    <div class="flex items-center mb-6">
        ...
        <span class="px-3 text-sm text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900">Or sign in with email</span>
        <div class="flex-1 border-t border-gray-200 dark:border-gray-700"></div>
    </div>
    ...
    <form action="#" method="POST">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
                <input id="remember" name="remember" type="checkbox" class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-500 dark:focus:ring-indigo-400 dark:ring-offset-gray-900 focus:ring-2 dark:bg-gray-800 dark:border-gray-700">
                <label for="remember" class="ml-2 text-sm text-gray-700 dark:text-gray-300">Remember me</label>
            </div>
            <a href="#" class="text-sm font-medium text-sky-500 hover:underline">Forgot password?</a>
        </div>
    ...
    <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
        Don't have an account? <a href="#" class="text-sky-500 hover:underline font-medium">Sign up</a>
    </p>
</div>
