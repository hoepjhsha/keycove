<div>
    ...
    <form wire:submit="login">
        <div class="relative">
            ...
            <input type="email" wire:model="form.email" class="w-full pl-10 pr-3 py-2.5 bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:focus:ring-indigo-400" placeholder="you@example.com" required autofocus>
        </div>
        <div class="mb-4">
            @error('form.email')
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('app.auth.password.request') }}" class="text-sm font-medium text-sky-500 hover:underline">Forgot password?</a>
        </div>
    ...
    <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
        Don't have an account? <a href="{{ route('app.auth.register') }}" class="text-sky-500 hover:underline font-medium">Sign up</a>
    </p>
</div>
