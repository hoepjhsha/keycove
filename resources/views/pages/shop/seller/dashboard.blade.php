<div class="space-y-6">
    ...
    <section class="grid gap-4">
        <article class="rounded-[1.75rem] border border-black/8 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-gray-900/85">
            <p class="text-[11px] font-semibold uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400">Shop commission</p>
            <p class="mt-3 text-3xl font-semibold text-gray-950 dark:text-white">{{ number_format($metrics['sellerEarnings'], 0, ',', '.') }} VND</p>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Platform fee {{ number_format($metrics['platformFee'], 0, ',', '.') }} VND · Wallet balance and holding are shown above.</p>
        </article>
    </section>
