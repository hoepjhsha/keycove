...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="light" class="scheme-light">
    <head>
        ...
        <title>{{ __('admin.errors.403.meta') }}</title>
        ...
        <div class="min-h-screen flex flex-col items-center justify-center px-4 py-12">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
                    <!-- Error Code -->
                    <div class="mb-6">
                        <span class="text-6xl font-black text-yellow-600 dark:text-yellow-400">403</span>
                    </div>

                    <!-- Error Title -->
                    <h2 class="text-2xl font-bold mb-3 text-slate-900 dark:text-white">
                        {{ __('admin.errors.403.title') }}
                    </h2>

                    <!-- Error Description -->
                    <p class="text-slate-600 dark:text-slate-400 mb-8">
                        {{ __('admin.errors.403.description') }}
                    </p>
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="/admin/dashboard" class="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-md font-semibold text-white bg-yellow-600 hover:bg-yellow-700 dark:bg-yellow-500 dark:hover:bg-yellow-600 transition-colors duration-200">
                ...
                <p class="text-center text-sm text-slate-500 dark:text-slate-500 mt-8">
                    {{ __('admin.errors.footer_with_title', ['code' => 403, 'title' => __('admin.errors.403.title')]) }}
                </p>
            </div>
        </div>
    </body>
