            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="/admin" class="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-md font-semibold text-white bg-yellow-600 hover:bg-yellow-700 dark:bg-yellow-500 dark:hover:bg-yellow-600 transition-colors duration-200">
                            Back to Dashboard
                        </a>
