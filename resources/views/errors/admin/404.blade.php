            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="/admin" class="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-md font-semibold text-white bg-slate-700 hover:bg-slate-800 dark:bg-slate-600 dark:hover:bg-slate-700 transition-colors duration-200">
                            Back to Dashboard
                        </a>
