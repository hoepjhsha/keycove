        ...
        <div class="min-h-screen flex flex-col items-center justify-center px-4 py-12">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
                    <!-- Error Code -->
                    <div class="mb-6">
                        <span class="text-6xl font-black text-red-600 dark:text-red-400">404</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <a href="{{ route('admin.dashboard.index') }}" class="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-md font-semibold text-white bg-slate-700 hover:bg-slate-800 dark:bg-slate-600 dark:hover:bg-slate-700 transition-colors duration-200">
                            Back to Dashboard
                        </a>
